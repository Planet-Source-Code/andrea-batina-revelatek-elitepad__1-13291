...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label Label4 
      ...
      Caption         =   "Copyright © Andrea Batina 1999-2000"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
Private Sub cmdSupport_Click()
    ShellExecute frmMDI.hWnd, "open", "mailto:andreab85@email.co.yu", 0&, 0&, vbNormal
End Sub
...
Public Sub StartSysInfo()
    ...
    Exit Sub
SysInfoErr:
    MsgE "System Information Is Unavailable At This Time", "ElitePad", 1, True
End Sub
