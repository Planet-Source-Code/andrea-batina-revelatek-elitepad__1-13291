...
Private Sub chkLoadTipsAtStartup_Click()
    ...
    RGSetKeyValue HKEY_LOCAL_MACHINE, SettingsPath, "Show Tips at Startup", chkLoadTipsAtStartup.Value
End Sub
...
Private Sub Form_Load()
    ...
    If LoadTips(App.Path & "\" & TIP_FILE) = False Then
        lblTipText.Caption = "That the tips file was not found? " & vbCrLf & vbCrLf & _
           "Please contact me for new tip file at E-Mail: andreab85@email.co.yu"
    End If
End Sub
